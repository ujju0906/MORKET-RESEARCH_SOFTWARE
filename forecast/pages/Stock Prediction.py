...
# ---------------stock selection------------------
STOCKS = np.array([ "GOOG", "GME", "META","AAPL",'TSLA'])  # TODO : include all stocks
...
st.sidebar.markdown("""
written by [VUTTHHHH GANG](https://github.com/ujju0906/MORKET-RESEARCH_SOFTWARE/tree/dev-hima)
""")
